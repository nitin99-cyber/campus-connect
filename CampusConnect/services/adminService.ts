...
const STORAGE_KEY = 'campus_connect_site_content';
...
We set out to build a platform that serves as the digital heartbeat of our campus. More than just a directory, we wanted to create an ecosystem.`,
  vision: "To democratize opportunity within the campus walls. We believe that every student, regardless of their branch or year, deserves a stage to showcase their skills and a network to fuel their growth.",
  ...
  developer: {
    name: "VisionX",
    role: "Building and Learning Tech",
    email: "visionx@gmail.com",
