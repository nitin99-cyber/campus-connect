...
export const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans relative">
      ...
      {/* Dynamic layout for login vs others */}
      <main className={`flex-grow relative z-10 ${isLoginPage ? 'w-full max-w-none px-0 py-0 pt-0' : 'container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-28'}`}>
        {children}
      </main>
